...
transform = transforms.Compose([
    ...
    transforms.ColorJitter(brightness=0.2, contrast=0.2),  # Add visual diversity
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.5]*3, std=[0.5]*3)
])

# Load data and split into train/val
full_dataset = MultiLabelDataset("composition_labels.csv", "composition_images", transform=transform)
...
model = MultiLabelResNet(num_classes=9).to(device)
