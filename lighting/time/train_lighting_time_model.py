...
full_dataset = MultiLabelDataset("lighting_time_labels.csv", "lighting_time_images", transform=transform)
...
model = MultiLabelResNet(num_classes=3).to(device)
...
# Save model
torch.save(model.state_dict(), "lighting_time_model.pth")
