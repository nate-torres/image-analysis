...
full_dataset = MultiLabelDataset("lighting_pattern_labels.csv", "lighting_pattern_images", transform=transform)
...
model = MultiLabelResNet(num_classes=6).to(device)
...
# Save model
torch.save(model.state_dict(), "lighting_pattern_model.pth")
