...
full_dataset = MultiLabelDataset("lighting_labels.csv", "lighting_images", transform=transform)
...
model = MultiLabelResNet(num_classes=13).to(device)
...
# Save model
torch.save(model.state_dict(), "lighting_model.pth")
